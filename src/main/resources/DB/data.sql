...
INSERT INTO togetherPost (together_post_id, post_id, location_id, user_id, capacity)
VALUES (1, 6, 1, 1, 8),
       (2, 7, 2, 2, 8),
       (3, 8, 3, 3, 8),
       (4, 9, 4, 4, 8),
...
INSERT INTO review(review_id, user_id, affectpost_id, write_at, content)
VALUES (1,1,1,'2023-04-01 12:00:00', '졸려졸려졸려'),
       (2,2,2,'2023-04-03 12:00:00', '22222222'),
       (3,3,3,'2023-04-05 12:00:00', '33333'),
       (4,4,4,'2023-04-07 12:00:00', '44444'),
       (5,5,5,'2023-04-09 12:00:00', '55555');

INSERT INTO likes(likes_id, post_id, user_id, like_status)
VALUES (1,1,1,true),
       (2,2,2,true),
       (3,3,3,true),
       (4,4,4,true),
...
INSERT INTO imageUrl(image_id, post_id, image_url)
